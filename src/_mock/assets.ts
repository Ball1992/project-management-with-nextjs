...
export const _roleNames = [
  `ผู้บริหารจัดการเว็บไซต์ (สามารถเข้าถึงได้บางส่วนของระบบ : Webmaster)`,
  `ผู้ดูแลระบบบริหารจัดการ (สามารถเข้าถึงได้ทุกส่วนของระบบ : Administrator)`,  
]

export const _blogGroups = [
  `เกร็ดความรู้`,
  `รีวิว`,
  `ประกาศต่างๆ`,  
]

export const _blogNames = [
  `เครื่องปรุงที่เราใช้ ดีอย่างไร ?`,
  `กะทิธัญพืช ที่ร้านเราเลือกใช้ดีอย่างไร ?`,
  `ข้าว กข.43 คืออะไร ?`, 
  `อาหารคลีน`, 
]

export const _viewAmt = [
  1,
  23,
  445,
  12,
