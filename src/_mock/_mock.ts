...
export const _mock = {
  ...
  roleName: (index: number) => _roleNames[index],
  viewAmt: (index: number) => _viewAmt[index],
  menu: (index: number) => _menus[index],
  blogNames: (index: number) => _blogNames[index],
  blogGroups: (index: number) => _blogGroups[index],
  // Text
