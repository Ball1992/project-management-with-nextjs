...
import { systemNavData } from '../nav-config-system';
...
export type SystemLayoutProps = LayoutBaseProps & {
...
export function SystemLayout({
  ...
  // Use system navigation data
  const navData = slotProps?.nav?.data ?? systemNavData;
