...
export function ListingTableFiltersResult({ filters, onResetPage, totalResults, sx }: Props) {
  ...
  return (
    <FiltersResult totalResults={totalResults} onReset={handleReset} sx={sx}>
      ...
      <FiltersBlock label="Offer Type:" isShow={currentFilters.offerType !== 'all'}>
        <Chip
          {...chipProps}
          label={currentFilters.offerType}
          onDelete={handleRemoveOfferType}
          sx={{ textTransform: 'capitalize' }}
        />
      </FiltersBlock>
